...
function gatherTestCaseURL(testCase, testSuite, baseUrlObj) {
  ...
  if(process.env.API_SUBSCRIPTION_QUERY_PARAMETER_NAME && process.env.API_SUBSCRIPTION_TOKEN) {
    urlObj.query += '&'+process.env.API_SUBSCRIPTION_QUERY_PARAMETER_NAME + '=' + process.env.API_SUBSCRIPTION_QUERY_TOKEN;
  }
